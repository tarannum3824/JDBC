...
class Main{
    public static void main(String [] args) throws ClassNotFoundException{
        ...
        String query="UPDATE  employee SET job_title='java developer',salary=100000 where id=20 ";
        try{
        ...
        try{
            ...
            if(rowsaffected>0){
                System.out.println("Update Successfully succesfully" + rowsaffected +"row Updated ");
            }
            else{
